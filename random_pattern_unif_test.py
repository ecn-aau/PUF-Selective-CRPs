# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 13:14:46 2023

@author: Mieszko Ferens

Script to run simulation for evaluating uniformity of traditional and
...
def main():
    ...
    filepath = Path(args.outdir + "out_unif_random_pattern_" + str(args.k) +
                    "XOR.csv")
    if(filepath.is_file()):
