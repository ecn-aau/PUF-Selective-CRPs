# -*- coding: utf-8 -*-
"""
Created on Fri Jun  9 13:16:40 2023

@author: Mieszko Ferens

Script to run simulation for evaluating uniformity of Binary Shifted Pattern
(BSP) CRP subsets.
"""
...
def main():
    ...
    filepath = Path(args.outdir + "out_unif_binary_pattern_" + str(args.k) +
                    "XOR.csv")
    if(filepath.is_file()):
